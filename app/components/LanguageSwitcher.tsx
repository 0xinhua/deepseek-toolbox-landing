...
export const LanguageSwitcher: React.FC<LanguageSwitcherProps> = ({ currentLocale }) => {
  ...
  return (
    <Select value={currentLocale} onValueChange={handleLanguageChange}>
      <SelectTrigger className="w-[60px] sm:w-[110px] h-8 text-sm bg-transparent border-none cursor-pointer shadow-none focus:ring-0 focus:ring-offset-0 px-2 sm:px-3">
        <SelectValue>
